...
public class App {
  public static void main(String[] args) {
    ...
    Event newEvent = new Event(guestNum, foodType, bevType, entertainmentType);
    System.out.println("~*~*~*~*~*~*~*~*~*~*~*~Gotham Party Planning~*~*~*~*~*~*~*~*~*~*~");
    ...
    if(changeEvent){
      ...
      System.out.println("Please choose the number of the specific food you want from the options below:");
      ...
      System.out.println("Please choose the number of the specific entertainment you want from the options below:");
      ...
      // System.out.println("Food: " + newEvent.gets)
